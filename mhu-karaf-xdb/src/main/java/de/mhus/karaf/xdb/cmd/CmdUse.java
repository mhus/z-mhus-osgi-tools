...
public class CmdUse implements Action {
	...
	public Object execute() throws Exception {
		...
		System.out.println("Global : xdb:" + M.l(XdbKarafApi.class).getApi() + "/" + M.l(XdbKarafApi.class).getService() + (M.l(XdbKarafApi.class).getDatasource() != null ? "/" + M.l(XdbKarafApi.class).getDatasource() : ""));
