...
public interface JmsManagerService {
    ...
    //	void addConnection(String name, String url, String user, String password) throws
    // JMSException;
    ...
    /**
     * Called if the connection is offline to inform all the channels to disconnect from the
     * connection.
     *
