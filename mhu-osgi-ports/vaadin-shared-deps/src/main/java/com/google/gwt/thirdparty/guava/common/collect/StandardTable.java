...
import static com.google.gwt.thirdparty.guava.common.base.Predicates.alwaysTrue;
import static com.google.gwt.thirdparty.guava.common.base.Predicates.equalTo;
import static com.google.gwt.thirdparty.guava.common.base.Predicates.in;
import static com.google.gwt.thirdparty.guava.common.base.Predicates.not;
import static com.google.gwt.thirdparty.guava.common.collect.Maps.safeContainsKey;
import static com.google.gwt.thirdparty.guava.common.collect.Maps.safeGet;

import com.google.gwt.thirdparty.guava.common.annotations.GwtCompatible;
import com.google.gwt.thirdparty.guava.common.base.Function;
import com.google.gwt.thirdparty.guava.common.base.Predicate;
import com.google.gwt.thirdparty.guava.common.base.Supplier;
import com.google.gwt.thirdparty.guava.common.collect.Maps.ImprovedAbstractMap;
import com.google.gwt.thirdparty.guava.common.collect.Sets.ImprovedAbstractSet;
...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
  ...
  private class Column extends ImprovedAbstractMap<R, V> {
    ...
    private class EntrySet extends ImprovedAbstractSet<Entry<R, V>> {
      ...
      @Override public void clear() {
        removeIf((java.util.function.Predicate<? super java.util.Map.Entry<R, V>>) alwaysTrue());
      }
      ...
      @Override public boolean retainAll(Collection<?> c) {
        return removeIf((java.util.function.Predicate<? super java.util.Map.Entry<R, V>>) not(in(c)));
      }
    }
    ...
    private class KeySet extends Maps.KeySet<R, V> {
      ...
      @Override public boolean retainAll(final Collection<?> c) {
        return removeIf((java.util.function.Predicate<? super R>) Maps.<R>keyPredicateOnEntries(not(in(c))));
      }
    }
    ...
    private class Values extends Maps.Values<R, V> {
      ...
      @Override public boolean remove(Object obj) {
        return obj != null && removeIf((java.util.function.Predicate<? super V>) Maps.<V>valuePredicateOnEntries(equalTo(obj)));
      }

      @Override public boolean removeAll(final Collection<?> c) {
        return removeIf((java.util.function.Predicate<? super V>) Maps.<V>valuePredicateOnEntries(in(c)));
      }

      @Override public boolean retainAll(final Collection<?> c) {
        return removeIf((java.util.function.Predicate<? super V>) Maps.<V>valuePredicateOnEntries(not(in(c))));
      }
    }
  }
