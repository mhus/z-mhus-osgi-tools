...
public interface ListenableFuture<V> extends Future<V> {
   ...
   * com.google.gwt.thirdparty.guava.common.util.concurrent.Futures}. For a simplified but general
   * listener interface, see {@link
   * com.google.gwt.thirdparty.guava.common.util.concurrent.Futures#addCallback addCallback()}.
   *
