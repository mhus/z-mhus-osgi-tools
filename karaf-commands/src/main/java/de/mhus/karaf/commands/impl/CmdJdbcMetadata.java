    ...
    public Object execute2() throws Exception {
        ...
        if (type.equals("schemas")) {
            ...
            ResultSet res =
                    con.getMetaData()
                            .getAttributes(
                                    attr(3, null), attr(2, null), attr(1, null), attr(0, null));
            out(res);
            con.close();
        } else if (type.equals("functions")) {
            Connection con = ds.getConnection();
            ResultSet res =
                    con.getMetaData().getFunctions(attr(2, null), attr(1, null), attr(0, null));
            out(res);
            con.close();
            ...
            ResultSet res =
                    con.getMetaData()
                            .getColumns(attr(3, null), attr(2, null), attr(0, null), attr(1, null));
            out(res);
            con.close();
