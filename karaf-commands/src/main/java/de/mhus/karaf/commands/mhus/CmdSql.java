            ...
            case "set":
                {
                    ...
                    else if (parameters[0].equals("writer")) analyzer = new SqlRuntimeWriter();
                    else if (parameters[0].equals("warning")) analyzer = new SqlRuntimeWarning();
                    else if (parameters[0].equals("reporter")) analyzer = new SqlReporter();
                    else {
                        OsgiBundleClassLoader loader = new OsgiBundleClassLoader();
                        analyzer =
                                (SqlAnalyzer)
                                        loader.loadClass(parameters[0])
                    ...
                    if (parameters != null)
                        analyzer.doConfigure(
                                new PropertiesConfig(MProperties.explodeToProperties(parameters)));
