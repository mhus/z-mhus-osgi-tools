...
public class CmdChannelAdd extends AbstractCmd {
    ...
    @Argument(
            ...
            name = "destination",
            required = true,
            description = "Name of the destination queue or topic",
            multiValued = false)
    String destination;
    ...
    @Argument(
            ...
            name = "interface",
            required = true,
            description = "Interface or Implementation",
            multiValued = false)
    String ifc;
    ...
    @Option(
            name = "-t",
            aliases = {"--topic"},
            description = "Destinantion is a topic",
            required = false,
            multiValued = false)
    boolean topic;
    ...
    @Option(
            name = "-s",
            aliases = {"--service"},
            description = "Channel is a service, not a client",
            required = false,
            multiValued = false)
    boolean service;
