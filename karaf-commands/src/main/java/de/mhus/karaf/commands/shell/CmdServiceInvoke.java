...
public class CmdServiceInvoke extends AbstractCmd {
    ...
    @Option(
            name = "-x",
            aliases = {"--index"},
            description = "Index of the invoked service",
            required = false,
            multiValued = false)
    int index = -1;
    ...
    public Object execute2() throws Exception {
        ...
        ServiceReference<?>[] res =
                FrameworkUtil.getBundle(CmdServiceInvoke.class)
                        .getBundleContext()
                        .getAllServiceReferences(serviceName, filter);
        ...
        Object service =
                FrameworkUtil.getBundle(CmdServiceInvoke.class).getBundleContext().getService(ref);
